...
class AppColors {
  ...
  static const Color darkBackgroundColor = Color(0xff17181B);
  static const Color darkCanvasColor = Color(0xff17181B);
  static const Color darkDividerColor = Color(0xff17181B);
  static const Color darkSecondaryColor = Color(0xff17181B);
